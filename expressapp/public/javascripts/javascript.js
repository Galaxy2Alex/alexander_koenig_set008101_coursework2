...
function user() {
	...
	document.getElementById("overlay-text").innerHTML = '<form action="/" method="post"><label for="username">Username: </label><input id="username" name="username" type="text" value="" autocomplete="off" required="required" /><br /><label for="password">Password: </label><input id="password" name="password" type="text" value="" autocomplete="off" required="required" /><br /><button type="submit">Login / Register</button></form><button onclick="overlayOff()">Close</button>';
